define('canon/tooltip', ['canon/core/component'], function (Component) {
  ...
  Tooltip = Component.extend({
    ...
    attach: function (selector) {
      ...
      this._element.on('mouseover.tooltip', $.proxy(function (e) {
        this._isToggleActive = true;
        showTooltip(this);
      }, this));

      this._element.on('mouseout.tooltip', $.proxy(function (e) {
        this._isToggleActive = false;
        hideTooltip(this);
      }, this));

      this._content.on('mouseover.tooltip', $.proxy(function (e) {
        this._isTooltipActive = true;
      }, this));

      this._content.on('mouseout.tooltip', $.proxy(function (e) {
    ...
    show: function () {
      ...
      this._content.offset({
        top: elementOffset.top + this._element.height() + OFFSET,
        left: elementOffset.left + this._element.width() + OFFSET
      });
    },
    hide: function () {
